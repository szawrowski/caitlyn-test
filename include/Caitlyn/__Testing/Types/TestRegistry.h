...
{
public:
    using Holder = std::map<std::string, std::vector<TestCase>>;
...
public:
    ...
    void AddTest(const std::string& suite_name, const std::string& test_name, const TestFunction func)
    {
...
private:
    ...
    static void LogSuiteStart(const std::string& suite_name, const size_t test_count)
    {
    ...
    void LogTestFailure(const TestCase& test, const std::string& message) const
    {
    ...
    static void LogSuiteEnd(const std::string& suite_name, const size_t test_count, const Duration& total_time)
    {
